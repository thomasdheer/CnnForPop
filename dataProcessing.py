# This file processes MIDI-files from a given folder into a trainable format.
# For more details, see the accompanying text, "Creating a Songwriting Tool Based on Convolutional Neural Networks
# and a Moving-Window Sampler" by Thomas D'heer (2020).
